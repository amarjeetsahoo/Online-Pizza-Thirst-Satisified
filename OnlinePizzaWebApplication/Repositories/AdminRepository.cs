...
namespace OnlinePizzaWebApplication.Repositories
{
    public class AdminRepository : IAdminRepository
    {
        ...
        public void SeedDatabase()
        {
            ...
            var piz3 = new Pizzas { Name = "Hawaii", Price = 75.00M, Category = cat1, Description = "A nice tasting pizza from Hawaii.", ImageUrl = "https://sworld.co.uk/img/img/106/photoAlbum/76832/originals/0.jpg", IsPizzaOfTheWeek = true };
            ...
            var piz5 = new Pizzas { Name = "Kebab Special", Price = 85.00M, Category = cat2, Description = "A special pizza with kebab for the hungry one.", ImageUrl = "https://wallpapercave.com/wp/wc1813154.jpg", IsPizzaOfTheWeek = true };
            var piz6 = new Pizzas { Name = "Pescatore", Price = 80.00M, Category = cat1, Description = "A pizza with taste from the ocean.", ImageUrl = "https://images7.alphacoders.com/596/thumb-1920-596343.jpg", IsPizzaOfTheWeek = true };
